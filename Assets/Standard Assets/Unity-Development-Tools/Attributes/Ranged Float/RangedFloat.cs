...
public class RangedFloat
{
    ...
    public static RangedFloat operator *(RangedFloat someRangedFloat, float mulVal)
    {
        return new RangedFloat(someRangedFloat.min * mulVal, someRangedFloat.max * mulVal);
    }

    public static RangedFloat operator +(RangedFloat someRangedFloat, RangedFloat otherRangedFloat)
    {
        return new RangedFloat(someRangedFloat.min + otherRangedFloat.min, someRangedFloat.max + otherRangedFloat.max);
    }
